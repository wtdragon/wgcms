...
<div id="header">
    <div id="logo">
        <a href="/" ><img src="<?php
          echo  get_template_directory_uri().'/images/logo.gif';?>" alt="北京单身交友俱乐部" /></a>
        <strong>[东直门]</strong>
    </div>
    <!-- logo结束 -->
    ...
    <div id="phone">
        ...
        <a href="http://wpa.qq.com/msgrd?v=3&uin=910489730&site=qq&menu=yes" target="_blank" class="qq" ><img src="
        <?php
            echo  get_template_directory_uri().'/images/qq.gif'; ?> "/></a>
    </div>
    <!-- phone结束 -->
